...
namespace Trabajofinal2.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Nacimiento")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Nacimiento")] Profesor profesor)
        {
            if (id != profesor.Id)
            {
                return NotFound();
