    ...
    public class AlumnosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Alumnos != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Alumnos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Nacimiento")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Nacimiento")] Alumno alumno)
        {
            if (id != alumno.Id)
            {
                return NotFound();
